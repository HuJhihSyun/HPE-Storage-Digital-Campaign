...
export default defineNuxtConfig({
  ...
  app: {
    baseURL: process.env.NODE_ENV === 'production' ? '/Data-Services-and-Storage/' : '/',
    ...
    head: {
      ...
      script: [
        {
          ...
          })(window,document,'script','dataLayer','GTM-P8NRV77L');
          `
        }
      ],
      ...
      noscript: [
        {
          innerHTML: `
          <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P8NRV77L"
            height="0" width="0"
