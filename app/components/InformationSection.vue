      ...
      <div class="w-full md:w-7/10 2xl:w-3/4 h-full px-6 sm:px-12 md:px-6 lg:px-8 xl:px-12">
        <div class="flex flex-col lg:flex-row justify-center items-start gap-8 2xl:gap-10 mt-10 mb-20 md:my-10 lg:my-20">
          ...
          <div class="w-full lg:w-2/3">
            ...
            class="inline-block pl-4 pr-4 sm:pl-8 sm:pr-30 md:pr-30 lg:pr-30 pb-3 pt-2 bg-linear-to-b from-[#01A982]/50 to-[#0070F8]/30 hover:from-[#01A982] hover:to-[#0070F8]/50 backdrop-blur-xs rounded-2xl border border-[#00E0AF] transition-all duration-200"
          >
            <img src="@/assets/images/robot-r.png" alt="robot" class="absolute hidden sm:block right-4 bottom-0 w-20 md:w-24 lg:w-24" />
