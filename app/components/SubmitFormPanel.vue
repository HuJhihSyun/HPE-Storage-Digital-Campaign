      ...
      <form class="w-full">
        ...
        >
          ...
          <ul class="m-0 p-0 flex flex-col gap-2 list-none">
            ...
            <li class="HPEGraphikRegular text-white text-xs">
              得獎公布：第一輪獎項主辦單位將於 2026 年 4 月 30 日前，於本活動網站公布得獎名單。
            </li>
            <li class="HPEGraphikRegular text-white text-xs">
              領獎方式：
              主辦單位於上述平台公布得獎名單後，承辦單位將於七個工作日內透過中獎者於活動期間留存之聯絡方式聯繫（電話、電子郵件），在中獎者完成得獎申報流程後，承辦單位將透過得獎者於網站留存之資料，以郵寄方式寄出贈品。中獎者必須本人參與本活動且不得轉讓資格。
            </li>
          </ul>
